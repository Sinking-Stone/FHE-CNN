...
void Bootstrapper::addLeftRotKeys_Linear_to_vector_3(vector<int> &gal_steps_vector) {
    ...
    int basicstep3 = 1;
    // std::cout<<"div_part1: "<<div_part1<<std::endl;
    // std::cout<<"div_part2: "<<div_part2<<std::endl;
    // std::cout<<"div_part3: "<<div_part3<<std::endl;
    // std::cout<<"totlen1: "<<totlen1<<std::endl;
    // std::cout<<"totlen2: "<<totlen2<<std::endl;
    // std::cout<<"totle3: "<<totlen3<<std::endl;
    // std::cout<<"basicstep1: "<<basicstep1<<std::endl;
    // std::cout<<"basicstep2: "<<basicstep2<<std::endl;
    // std::cout<<"basicstep3: "<<basicstep3<<std::endl;
    ...
    // std::cout<<"gs1=giantstep(totlen1 + 1)=                                       "<<gs1<<std::endl;
    // std::cout<<"gs1_e=giantstep(2 * totlen1 + 1)=                                 "<<gs1_e<<std::endl;
    // std::cout<<"gs2=giantstep(2 * totlen2 + 1)=                                   "<<gs2<<std::endl;
    // std::cout<<"gs3=giantstep(2 * totlen3 + 1)=                                   "<<gs3<<std::endl;
    // std::cout<<"basicstart1=-totlen1 + gs1 * floor((totlen1 + 0.0) / (gs1 + 0.0))="<<basicstart1<<std::endl;
    // std::cout<<"giantfirst1=-floor((totlen1 + 0.0) / (gs1 + 0.0))=                "<<giantfirst1<<std::endl;
    // std::cout<<"giantlast1=floor((2 * totlen1 + 0.0) / (gs1 + 0.0)) + giantfirst1="<<giantlast1<<std::endl;
    // std::cout<<"giantlast1_e=floor((totlen1 + 0.0) / (gs1 + 0.0))=                "<<giantlast1_e<<std::endl;
    // std::cout<<"basicstart2=-totlen2 + gs2 * floor((totlen2 + 0.0) / (gs2 + 0.0))="<<basicstart2<<std::endl;
    // std::cout<<"giantfirst2=-floor((totlen2 + 0.0) / (gs2 + 0.0))=                "<<giantfirst2<<std::endl;
    // std::cout<<"giantlast2=floor((2 * totlen2 + 0.0) / (gs2 + 0.0)) + giantfirst2="<<giantlast2<<std::endl;
    // std::cout<<"basicstart3=-totlen3 + gs3 * floor((totlen3 + 0.0) / (gs3 + 0.0))="<<basicstart3<<std::endl;
    // std::cout<<"giantfirst3=-floor((totlen3 + 0.0) / (gs3 + 0.0))=                "<<giantfirst3<<std::endl;
    // std::cout<<"giantlast3=floor((2 * totlen3 + 0.0) / (gs3 + 0.0)) + giantfirst3="<<giantlast3<<std::endl;
    // std::cout<<"basicstart1: "<< basicstart1<<"\tbasicstart1 + gs1 = "<<basicstart1 + gs1<<std::endl;
    ...
    // std::cout<<"gal_steps_vector.size()= "<<gal_steps_vector.size()<<"\t内容如下"<<std::endl;
